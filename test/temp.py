...
def home():
    ...
    return Html(
        ...
        Body(
            Div(
                # Existing content...
                Div(id='calendar', cls='calendar-widget'),
                Script("""
                    document.addEventListener('DOMContentLoaded', function() {
                        var calendarEl = document.getElementById('calendar');
                        var calendar = new FullCalendar.Calendar(calendarEl, {
                            initialView: 'dayGridMonth',
                            events: """ + str([{'title': 'Booked', 'start': date} for date in booked_dates]) + """
                        });
                        calendar.render();
                    });
                """)
                ...
                Form(
                    Fieldset(
                        ...
                        Div(
                            ...
                            P(f'Booked Dates: {booked_dates}'),  # Improved display
                            P(f'Guests: {guess}'),
